...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align">
  ...
  <a href="#" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Delete</a>
...
<div class="w3-row-padding w3-center">
	...
	<form class="w3-container w3-card-4">
	  <h2>Delete one tuple from works on with</h2>
...
<%
   ...
   try {
	...
	int rs = myUtil.deleteFromWorksOn(essn, pno);
	%>
		<div class="w3-row-padding w3-center">
			<div class = "w3-half" style="margin: 0 auto; margin-bottom:50px; width: 90%;">
				<% if(rs == 1 || rs == 0){ %><p>Tuples Edited: <%out.println(rs); }%></p>
			</div>
		</div>
	<% 
