...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align">
  ...
  <a href="#" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Update</a>
...
<div class="w3-row-padding w3-center">
	...
	<form class="w3-container w3-card-4">
	  <h2>Update works_on, add more hours to</h2>
	  <div class="w3-section">      
	    <input class="w3-input" name="essn" type="text" required>
	    <label>Employee SSN </label>
	  </div>
	  <div class="w3-section">      
	    <input class="w3-input" name="pno" type="text" required>
	    <label>Project Number </label>
	  </div>
	  <div class="w3-section">      
	    <input class="w3-input" name="hrs" type="text" required>
	    <label>Hours </label>
	  </div>
...
<% 
	// For Update works_on, add more hours to(essn, pno, hours)
	try {
		String essn = request.getParameter("essn");
		String pno = request.getParameter("pno");
		String hours = request.getParameter("hrs");
		int result = myUtil.updateWorksOn(essn, pno, hours);
		%>
		<div class="w3-row-padding w3-center">
			<div class = "w3-half" style="margin: 0 auto; margin-bottom:50px; width: 90%;">
				<% if(result == 1){ %><p>Tuples Edited: <%out.println(result); }%></p>
			</div>
		</div>
		<% 
